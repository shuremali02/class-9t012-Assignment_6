...
export default function Footer() {
  return (
    ...
    <footer className="bg-gray-300 text-black shadow-md shadow-gray-900 p-5 py-5">
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 py-12 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
